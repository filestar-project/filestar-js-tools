...
var filecoin_rpc_client_1 = require("@glif/filecoin-rpc-client");
...
var Filecoin = /** @class */ (function () {
    function Filecoin(provider, config) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.jsonRpcEngine.request('MpoolPush', signedMessage)];
                    case 1:
                        tx = _a.sent();
                        return [2 /*return*/, tx];
                }
        ...
        this.gasEstimateMaxFee = function (message, useMsgGas) {
            if (useMsgGas === void 0) { useMsgGas = false; }
            return __awaiter(_this, void 0, void 0, function () {
                var feeCap_1, limit_1, msgWithGas, feeCap, limit;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            // here we use BigNumber straight up, because multiplication has to happen in non decimal amounts
                            if (useMsgGas) {
                                feeCap_1 = new bignumber_js_1.default(message.GasFeeCap);
                                limit_1 = new bignumber_js_1.default(message.GasLimit);
                                return [2 /*return*/, {
                                        maxFee: new filecoin_number_1.FilecoinNumber(feeCap_1.times(limit_1), 'attofil'),
                                        message: message,
                                    }];
                            }
                            return [4 /*yield*/, this.gasEstimateMessageGas(message)];
                        case 1:
        ...
        this.gasCalcTxFee = function (gasFeeCap, gasPremium, gasLimit, baseFee, gasUsed) { return __awaiter(_this, void 0, void 0, function () {
            var gasFeeCapBN, gasPremiumBN, gasLimitBN, baseFeeBN, gasUsedBN, rightSideMinimum, multiplier, rightSide, leftSide, fee;
            return __generator(this, function (_a) {
                ...
                rightSideMinimum = bignumber_js_1.default.minimum(gasFeeCapBN.minus(baseFeeBN), gasPremiumBN);
                multiplier = bignumber_js_1.default.maximum(0, rightSideMinimum);
                rightSide = gasLimitBN.times(multiplier);
                leftSide = gasUsedBN.times(baseFeeBN);
                fee = new filecoin_number_1.FilecoinNumber(leftSide.plus(rightSide), 'attofil');
                return [2 /*return*/, fee];
            });
        }); };
        if (!provider)
